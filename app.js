...
var question4 = prompt('My uncles legally hunted and killed a gray whale in 1999 on a hand carved canoe with harpoons and a .577 T-rex, after fasting, bathing in ice water and covering their bare skin in stinging nettles.').toLowerCase();
...
while (question4 != 'yes' && question4 != 'y' && question4 != 'no' && question4 != 'n' && question4 != 'true' && question4 !='false') {
  ...
  alert('Please answer either Yes, Y, No, N, True or False. \(not case sensitive\)');
  question4 = prompt('My uncles legally hunted and killed a gray whale in 1999 on a hand carved canoe with harpoons and a .577 T-rex, after fasting, bathing in ice water and covering their bare skin in stinging nettles.').toLowerCase();
}

if (question4 === 'yes' || question4 === 'y' || question4 === 'true') {
  alert('Correct! The Makah tribe was granted whaling rights in our treaty with the US government in 1855, and my uncles succesfully harvested one on May 17, 1999. The discipline and training required by the tribe in order to participate in these hunts is extremely difficult.');
} else if (question4 === 'no' || question4 === 'n' || question4 === 'false') {
  alert('That statement was actually true, believe it or not. The Makah tribe was granted whaling rights in our treaty with the US government in 1855, and my uncles succesfully harvested one on May 17, 1999. The discipline and training required by the tribe in order to participate in these hunts is extremely difficult.');
};
